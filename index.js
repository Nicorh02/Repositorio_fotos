...
function cargafotos() {
    ...
    .then(contenido => {
        ...
        contenido.forEach((foto) => {
            ...
            tamaño.innerHTML="<strong>Tamaño: </strong>" + (FileSize/1024000).toLocaleString('es-ES') + " MB";
            tarjeta.appendChild(tamaño);

            //Cargando alto
            let alto = document.createElement("div");
            alto.innerHTML="<strong>Alto: </strong>" + Height + " píxeles";
            tarjeta.appendChild(alto);

            //Cargando ancho
            let ancho = document.createElement("div");
            ancho.innerHTML="<strong>Ancho: </strong>" + Width + " píxeles";;
